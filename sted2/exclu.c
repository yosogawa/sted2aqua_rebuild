...
redis:
  ...
  while( 1){
	...
	if(mm==0){
		B_LOCATE(15,yy);/*sinput(user_exc_memo[nn],24);*/ line_input(user_exc_memo[nn], 24); /* 2015.3.27. Toshi Nagata sinput->line_input */
	  fnc_dis(4+3);
	}else{
	  int	c;
	  B_LOCATE(14+x*3,yy);
...
/*
  ...
  if(ln>=32*1024+512){msg("¥Ð¥Ã¥Õ¥¡¤¬°ìÇÕ¤Ë¤Ê¤ê¤Þ¤·¤¿");break;}
  }
  }
